...
EXPORT_SYMBOL_FOR_TESTS_ONLY(dc_fixpt_from_int_test);
...
EXPORT_SYMBOL_FOR_TESTS_ONLY(dc_fixpt_from_fraction_test);
...
EXPORT_SYMBOL_FOR_TESTS_ONLY(dc_fixpt_mul_test);
...
EXPORT_SYMBOL_FOR_TESTS_ONLY(dc_fixpt_sqr_test);
...
EXPORT_SYMBOL_FOR_TESTS_ONLY(dc_fixpt_recip_test);
